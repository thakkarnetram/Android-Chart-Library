package github.thakkarnetram.chartlibrary.charting.animation;
...
public class ChartAnimator {
    ...
    public void animateX(int durationMillis) {
        animateX(durationMillis, github.thakkarnetram.chartlibrary.charting.animation.Easing.Linear);
    }
